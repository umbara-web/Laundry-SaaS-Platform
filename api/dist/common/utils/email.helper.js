...
exports.sendComplaintStatusEmail = sendComplaintStatusEmail;
const nodemailer_1 = require("./nodemailer");
const env_config_1 = require("../../configs/env.config");
async function sendVerificationEmail(to, name, verificationLink) {
    const mailOptions = {
        from: env_config_1.GMAIL_EMAIL,
        to,
...
async function sendComplaintStatusEmail(to, name, complaintId, status, orderId) {
    const statusLabels = {
    ...
    const mailOptions = {
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background-color: #f9f9f9; padding: 30px; border-radius: 0 0 8px 8px;">
          ...
          <p>Status komplain Anda untuk Pesanan <strong>#${orderId.slice(0, 8)}</strong> telah diperbarui menjadi:</p>
